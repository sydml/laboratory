package com.sydml.framework.ioc.config;
...
public interface ConfigConstant {
    ...
    String BASE_PACKAGES = "framework.base.packages";

    String JSP_PATH = "framework.jsp.path";

    String ASSET_PATH = "framework.asset.path";
